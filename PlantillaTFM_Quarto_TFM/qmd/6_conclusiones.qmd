...
4. Los resultados nanopartícula-proteína mostraron que (ZnO)$_{12}$ presentó energías de interacción más negativas que (Ag)$_{13}$ y (Au)$_{13}$ frente a las proteínas evaluadas. Por ello, (ZnO)$_{12}$ tuvo un peso dominante en las combinaciones mejor posicionadas del análisis contextual.

5. El ácido fólico es el ligando con comportamiento más consistente dentro del análisis contextual, y (ZnO)$_{12}$ es la nanopartícula que más favorece el índice en el conjunto estudiado.
