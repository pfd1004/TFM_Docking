...
info.to_csv("resultados/diagnosticos/diagnostico_columnas.csv", index=False)
...
corr_df.to_csv("resultados/diagnosticos/correlaciones_features_targets.csv", index=False)

print("\nTop 25 variables más correlacionadas con las y:")
print(corr_df.head(25).to_string(index=False))

print("\nArchivos creados:")
print("resultados/diagnosticos/diagnostico_columnas.csv")
print("resultados/diagnosticos/correlaciones_features_targets.csv")