...
FEATURES_FILE = Path("datasets/membrana_features.csv")
...
merged.to_csv("datasets/membrana_features_corregido.csv", index=False)
# XLSX_DESACTIVADO merged.to_excel("membrana_features_corregido.xlsx", index=False)
