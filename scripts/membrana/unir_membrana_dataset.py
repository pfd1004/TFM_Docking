...
DATASET = "datasets/dataset_descriptores.csv"
MEMBRANA = "datasets/membrana_features_corregido.csv"
...
merged.to_csv("datasets/dataset_descriptores_membrana.csv", index=False)
# XLSX_DESACTIVADO merged.to_excel("dataset_descriptores_membrana.xlsx", index=False)

print("\nCreados:")
print("datasets/dataset_descriptores_membrana.csv")
