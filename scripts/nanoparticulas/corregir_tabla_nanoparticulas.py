...
df.to_csv("resultados/nanoparticulas/resultados_docking_nanoparticulas_corregido.csv", index=False)
# XLSX_DESACTIVADO df.to_excel("resultados_docking_nanoparticulas_corregido.xlsx", index=False)
