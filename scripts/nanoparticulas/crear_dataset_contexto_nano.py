...
DATASET = "datasets/dataset_descriptores_membrana.csv"
NANO = "resultados/nanoparticulas/resultados_docking_nanoparticulas_corregido.csv"

OUT_LONG = "resultados/nanoparticulas/dataset_ligando_nano_proteina_contexto_long.csv"
OUT_RANKING = "resultados/nanoparticulas/ranking_contextual_ligando_nano_proteina.csv"
OUT_NANO_WIDE = "resultados/nanoparticulas/tabla_nano_proteina_contexto_wide.csv"
...
# XLSX_DESACTIVADO data.to_excel("dataset_ligando_nano_proteina_contexto_long.xlsx", index=False)
...
# XLSX_DESACTIVADO ranking[ranking_cols].to_excel("ranking_contextual_ligando_nano_proteina.xlsx", index=False)
...
# XLSX_DESACTIVADO nano_wide.to_excel("tabla_nano_proteina_contexto_wide.xlsx", index=False)
